...
BasicGame.Game.prototype = {
    ...
    create: function () {
        ...
        this.timertext = this.add.text(this.world.centerX + 20, 20, "Time", {
            font: "30px Arial",
            fill: "#ffffff",
            align: "center"
        });
        this.timertext.visible = false;
        this.clicktext = this.add.text(this.world.centerX + 20, 80, "Clicks", {
            font: "30px Arial",
            fill: "#ffffff",
            align: "center"
        });
    ...
    checkMap: function () {
        ...
        this.add.tween(this.titleimage).to({
            x: 100
    ...
    resetTexts: function (a) {
        switch (a) {
            case 1:
                this.clicktext.anchor.setTo(0, 0);
